...
Module["asm"] = asm;
var _GetRandomNumber = Module["_GetRandomNumber"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_GetRandomNumber"].apply(null, arguments)
};

var _SeedRandomNumberGenerator = Module["_SeedRandomNumberGenerator"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_SeedRandomNumberGenerator"].apply(null, arguments)
};
