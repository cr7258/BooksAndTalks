...
function _StringReturnValueWithNoParameters(){ const greetings = "Hello from StringReturnValueWithNoParameters"; const byteCount = (Module.lengthBytesUTF8(greetings) + 1); const greetingsPointer = Module._malloc(byteCount); Module.stringToUTF8(greetings, greetingsPointer, byteCount); return greetingsPointer; }
